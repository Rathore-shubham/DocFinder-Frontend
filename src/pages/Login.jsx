    ...
    try {
      if (state === "Sign Up") {
        const { data } = await axios.post(
          "https://DocFinder-backend-1af3.onrender.com/api/user/register",
          { name, email, password }
        );
        ...
        const { data } = await axios.post(
          "https://DocFinder-backend-1af3.onrender.com/api/user/login",
          { email, password }
        );
        ...
        {state === "Sign Up" ? (
          <div className="w-full ">
            ...
            <input
              ...
              value={name}
              className="border text-black border-[#DADADA] rounded w-full p-2 mt-1"
              type="text"
              required
            />
          </div>
